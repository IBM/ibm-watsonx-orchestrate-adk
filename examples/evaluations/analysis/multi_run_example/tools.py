...
@tool(name="get_assignment_id_hr_usecase", description="get the assignment id from username", permission=ToolPermission.ADMIN)
...
@tool(name="get_timeoff_schedule_hr_usecase", description="get timeoff_schedule", permission=ToolPermission.ADMIN)
...
@tool(name="get_direct_reports_hr_usecase", description="get direct reports", permission=ToolPermission.ADMIN)
