...
from examples.flow_builder.document_extractor_structured.tools.document_extractor_with_tables import (
    build_docext_flow,
)
...
async def main():
    ...
    my_flow_definition.dump_spec(
        f"{generated_folder}/structure_document_extractor_flow.json"
    )
    global flow_run
