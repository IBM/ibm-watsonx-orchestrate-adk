...
agent1 = Agent(
    ...
    """,
    llm="watsonx/openai/gpt-oss-120b", #Optional, Default=watsonx/openai/gpt-oss-120b
    style=AgentStyle.REACT_CORE,  #Optional, Valid options = [AgentStyle.DEFAULT, AgentStyle.REACT, AgentStyle.REACT_CORE]
    collaborators=[
        agent2,
        "algebra_agent"
    ],
