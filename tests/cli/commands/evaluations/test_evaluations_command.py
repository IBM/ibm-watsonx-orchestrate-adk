...
class TestGenerate:
    ...
    def test_generate_success(self, generate_paths, user_env_file):
        with patch(
            "ibm_watsonx_orchestrate.cli.commands.evaluations.evaluations_controller.EvaluationsController.generate"
        ) as mock_generate:
...
class TestValidateExternal:
    ...
    def config_content(self):
        return {"auth_scheme": "api_key", "api_url": "test-url"}
    ...
    def test_validate_external_success(
        self, config_content, external_agent_config, csv_file, user_env_file
    ):
        with patch(
            "ibm_watsonx_orchestrate.cli.commands.evaluations.evaluations_controller.EvaluationsController.external_validate"
        ) as mock_validate:
...
class TestValidateNativeAgent:
    ...
    def test_validate_native_agent(self, tsv_file, user_env_file):
        with patch(
            "ibm_watsonx_orchestrate.cli.commands.evaluations.evaluations_controller.EvaluationsController.generate_performance_test"
        ) as mock_perf_test:
            with patch(
...
class TestRedTeaming:
    def test_list_plans_calls_controller(self):
        with patch(
            "ibm_watsonx_orchestrate.cli.commands.evaluations.evaluations_controller.EvaluationsController.list_red_teaming_attacks"
        ) as mock_list:
    ...
    def test_plan_calls_generate_red_teaming_attacks(self, user_env_file):
        with patch(
            "ibm_watsonx_orchestrate.cli.commands.evaluations.evaluations_controller.EvaluationsController.generate_red_teaming_attacks"
        ) as mock_generate:
    ...
    def test_run_calls_run_red_teaming_attacks(self, user_env_file):
        with patch(
            "ibm_watsonx_orchestrate.cli.commands.evaluations.evaluations_controller.EvaluationsController.run_red_teaming_attacks"
        ) as mock_run:
