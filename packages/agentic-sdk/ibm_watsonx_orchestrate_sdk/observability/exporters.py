...
def create_exporter(config: TracerConfig) -> Any:
    ...
    logger.warning(
        "WXO_OTLP_ENDPOINT is not set; traces will be logger.debuged to the console. "
