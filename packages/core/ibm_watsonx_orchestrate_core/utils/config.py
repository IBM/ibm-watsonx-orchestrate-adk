...
from ibm_watsonx_orchestrate_core.types.tools import RegistryType
...
CONTEXT_ACTIVE_WORKSPACE_OPT = "active_workspace"
...
DEFAULT_CONFIG_FILE_CONTENT = {
    CONTEXT_SECTION_HEADER: {
        CONTEXT_ACTIVE_ENV_OPT: None,
        CONTEXT_ACTIVE_WORKSPACE_OPT: None
    },
